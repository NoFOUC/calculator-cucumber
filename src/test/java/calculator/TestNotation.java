...
class TestNotation {
	...
	void testOutput(String symbol) {
		...
		int value2 = 6;
		Operation op = null;
		//List<Expression> params = new ArrayList<>(Arrays.asList(new RealNumber(value1),new RealNumber(value2)));
		List<Expression> params = Arrays.asList(new RealNumber(value1),new RealNumber(value2));
		try {
